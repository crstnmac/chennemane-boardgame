/**
 * Preload bridge — contextIsolation sandbox API (hello-pear-electron shape).
 */
...
contextBridge.exposeInMainWorld('bridge', {
  ...
  onDeepLink: (listener) => {
    const wrap = (_evt, url) => listener(url)
    ipcRenderer.on('pear:deep-link', wrap)
    return () => ipcRenderer.removeListener('pear:deep-link', wrap)
  },
})
